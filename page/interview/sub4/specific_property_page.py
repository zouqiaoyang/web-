...
# 采访-个别财产账
class SpecificPropertyPage(BaseAction):
    ...
    sub_menu1 = By.XPATH, "//li[4]/ul/li[contains(text(), '个别财产账')]"      # 个别财产账按钮
    sub_menu1_btn = By.XPATH, "//button/span[contains(text(), ' 查询')]"  # 催缺单-查询 按钮
